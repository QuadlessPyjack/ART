...
const uint8_t ssd1306_init_sequence [] PROGMEM = {	// Initialization Sequence
	...
	0x40,    		// --set start line address 0x10,
...
void ssd1306_send_command_start(void) {
	...
	ssd1306_send_byte(0x80);	// write command
}
...
//}
//
//void ssd1306_string_font6x8xy(uint8_t x, uint8_t y, const char s[]) {
	//uint8_t ch, j = 0;
	//while (s[j] != '\0') {
		//ch = s[j] - 32;
		//if (x > 64) {
		...
		//ssd1306_send_data_start();
		//for (uint8_t i = 0; i < 6; i++) {
			//ssd1306_send_byte(pgm_read_byte(&ssd1306xled_font6x8[ch * 8 + i]));
		//}
		//ssd1306_send_data_stop();
		//ssd1306_setpos(x, y + 1);
		//ssd1306_send_data_start();
		//for (uint8_t i = 0; i < 6; i++) {
			//ssd1306_send_byte(pgm_read_byte(&ssd1306xled_font6x8[ch * 8 + i + 6]));
		//}
		//ssd1306_send_data_stop();
		//x += 6;
		//j++;
...
//{
	//ssd1306_send_command_start();
	//ssd1306_send_byte(SSD1306_COLUMNADDR);
	//ssd1306_send_byte(x);
	//ssd1306_send_byte(x + w - 1);
	//ssd1306_send_byte(SSD1306_PAGEADDR);
	//ssd1306_send_byte(y);
	//ssd1306_send_byte((s_displayHeight >> 3) - 1);
	//ssd1306_send_data_stop();
//}
...
//{
	//uint8_t i, j;
	//uint8_t remainder = (64 - x) < w ? (w + x - 64): 0;
	//w -= remainder;
	...
	//{
		//for(i=w;i>0;i--)
		//{
			//ssd1306_send_byte(s_invertByte^pgm_read_byte(buf++));
		//}
		//buf += remainder;
		//ssd1306_nextRamPage();
	//}
